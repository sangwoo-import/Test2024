...
class SurveyDetailActivity : AppCompatActivity(), SurveyDetailProvider.CallBack,
    ...
    override fun completeSurveyDetail(
        ...
        if (codeA.equals("100")) {
            ...
            //  답변 여부(answerAt)를 위해 여기선 response 성공시 recyclerview 생성 -> adapter 붙이기
            ...
            adapter = SurveyDetailRecyclerViewAdapter(
                mutableListOf(), this@SurveyDetailActivity, answerAtA
            )
            ...
            if (answerAtA.equals("Y")) {
                ...
                Toast.makeText(
                    this@SurveyDetailActivity, "이미 답변이 완료된 설문 조사입니다.",
                    Toast.LENGTH_SHORT
                ).show()
